...
#define AD_Led3_Placa1          0x08 // J3 da placa na posição 1
...
#define AD_Led3_Placa2          0x08 // J3 da placa na posição 2
    ...
    if ((EmTeste)&&(TestDelay == 0)&&(ApoioFlags == 0)) {
        switch (EstagioTeste) {
            ...
            case GravaVersaoFinal: //Grava firmware final
                if (TimeOutDelay == 0) {
                    if ((PosicaoPlaca1 == 0) || (DefeitoPlaca1 == 1)) //para não iniciar gravação na posição que não possuir placa
                    {

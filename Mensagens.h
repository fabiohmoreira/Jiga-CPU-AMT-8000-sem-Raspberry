...
unsigned char MensagensGerais[100][24] ={
    ...
    "   Falha GPRS placa 1   ", // 26
    "   Falha WiFi placa 1   ", // 27
    " Falha ethernet placa 1 ", // 28
    "  Falha bateria placa 1 ", // 29
    "    Falha RF placa 1    ", // 30
    "   Falha EEPROM placa 1 ", // 31
    "    Defeitos placa 2    ", // 17
    ...
    "         INICIO         ", // 61
    "  Bug na gravacao!!!    ", // 62
    "  Executando testes ... ", // 63
    "Validando FW de teste...", // 64
    "  Validando FW final ...", // 65
    "Validando FW de teste...", // 66
    " Gravacao final placa 1 ", // 67
    " Gravacao final placa 2 ", // 68
    " Mensagem posicao 69... ", // 69
    " Mensagem posicao 70... ", // 70
    " Mensagem posicao 71... ", // 71
    " Mensagem posicao 72... ", // 72
    " Mensagem posicao 73... ", // 73
    " Mensagem posicao 74... ", // 74
    " Mensagem posicao 75... ", // 75
    " Mensagem posicao 76... ", // 76
    " Mensagem posicao 77... ", // 77
    " Mensagem posicao 78... ", // 78
    " Mensagem posicao 79... ", // 79
    " Mensagem posicao 80... ", // 80
    " Mensagem posicao 81... ", // 81
    " Mensagem posicao 82... ", // 82
    " Mensagem posicao 83... ", // 83
    " Mensagem posicao 84... ", // 84
    " Mensagem posicao 85... ", // 85
    " Mensagem posicao 86... ", // 86
    " Mensagem posicao 87... ", // 87
    " Mensagem posicao 88... ", // 88
    " Mensagem posicao 89... ", // 89
    " Mensagem posicao 90... ", // 90
    " Mensagem posicao 91... ", // 91
    " Mensagem posicao 92... ", // 92
    " Mensagem posicao 93... ", // 93
    " Mensagem posicao 94... ", // 94
    " Mensagem posicao 95... ", // 95
    " Mensagem posicao 96... ", // 96
    " Mensagem posicao 97... ", // 97
    " Mensagem posicao 98... ", // 98
    " Mensagem posicao 99... ", // 99
};
